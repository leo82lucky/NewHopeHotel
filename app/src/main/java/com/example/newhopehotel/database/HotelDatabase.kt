...
@Database(
    entities = [RegisterEntity::class, CheckInCheckOutEntity::class, MorningCallEntity::class, RoomServiceEntity::class, CleaningListEntity::class, FeedbackEntity::class],
